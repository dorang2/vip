...
print(Style.BRIGHT + Fore.WHITE+"           ___  _           ___       __\n          / _ \\(_)______   / _ )___  / /_\n         / // / / __/ -_) / _  / _ \\/ __/\n        /____/_/\\__/\\__/ /____/\\___/\\__/" + Style.BRIGHT + Fore.CYAN + "\n\n   PRIVATE For :" + Style.BRIGHT + Fore.RED + " PencariCryptoVip~Member~Only!!\n")
...
def dice(ws,ls):
   ...
   try:
     ...
     print (hijau+"           Starting Balance",res+str(rev(str(star_bal))))
     n = 0
     burst = False
     ...
     #try:
        ...
        if _lowercase(obj["Interface"]["Random"]["Auto"]) == "on":
           ...
           if cok == 3:
              chance = bg_end+" "+str(hasil_chance)+"   "+"%"+" "+bg_end
           if cok == 4:
              chance = bg_end+" "+str(hasil_chance)+"  "+"%"+" "+bg_end
           if cok == 5:
              chance = bg_end+" "+str(hasil_chance)+" "+"%"+" "+bg_end
           ...
           chance = bg_end+"  "+str(obj["Interface"]["Chance"])+" %"+" "+bg_end
        ...
        if jsn["PayOut"] is not a:
           ...
           if prof > 0:
              if _lowercase(obj["Interface"]["Random"]["Auto"]) == "on":
                 print ('\x1b[1;37;100m'+" "+str(rolebet)+" "+'\x1b[0m'+""+"["+ij+ str(rev(str(amount)))+" ]","Profit",ij+rev(str(profw)),kn+str(rev(str(bal)))+rs)
              else:
        ...
        if no_lose > total_lose:
           ...
           stats_rolebet_win = False
           total_lose +=1
        sys.stdout.write("           "+seed_on_off+rs+kn+" "+bg_ab+  "WS "+str(total_win)+" "+     bg_end+" "+bg_rd+"LS "+str(total_lose)+" "+bg_end+" "+" RollBet : "+str(total_roll)+"\r")


   except:
     print ("")
     sys.exit()
print(Style.BRIGHT + Fore.GREEN +"\n        | Have 2FA? click enter if none |       \n")
otp = input("2FA : ")
print(Style.BRIGHT+Fore.RED+" 1. Doge")
print(Style.BRIGHT+Fore.GREEN+" 2. LTC")
print(Style.BRIGHT+Fore.YELLOW+" 3. ETH\n")
koin = input("Select Coin :")
if koin == "1":
  coin = "doge"
elif koin == "2":
  coin = "ltc"
  ...
  coin = "eth"
os.system ("clear")
r = c.get(url,headers=ua,data={"a": "Login","Key": "7ec7f8a2c9724b2cbb8ed75e72b47ee9","Username": obj["Account"]["Username"],"Password": obj["Account"]["Password"],"Totp": otp})
